        ...
        <footer
            ...
            <div className="flex flex-row w-full justify-around">
                <div className="flex flex-col justify-start items-start">
                    ...
                    <span className="text-2xl my-2">{"\<Social Icons Placeholder\>"}</span>
                </div>
            ...
            <div
                className="w-full justify-between text-xs border-t dark:border-white/5 border-black/5 p-6 m-2 mx-8 pb-0 flex">
