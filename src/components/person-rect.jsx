...
const PersonRect = ({ config }) => {
    return (
        <a href={`${config.firstName.toLowerCase()}-${config.lastName.toLowerCase()}`} className="cursor-pointer relative flex items-center justify-center flex-col rounded-lg w-full h-auto md:w-64 h-[60vh] md:h-96 bg-neutral-300 dark:bg-neutral-800">
